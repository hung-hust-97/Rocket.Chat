...
class AppRuntimeManager {
    ...
    startRuntimeForApp(appPackage, options = { force: false }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.subprocesses[appId] = new AppsEngineDenoRuntime_1.DenoRuntimeSubprocessController(this.manager, appPackage);
